...
import org.tensorflow.ndarray.initializer.StringNdArrayInitializerTestBase;

import java.util.function.Consumer;

public class StringDenseNdArrayInitializerTest extends StringNdArrayInitializerTestBase {

  @Override
  protected NdArray<String> newArray(Shape shape, long numValues, Consumer<NdArrayInitializer<String>> init) {
    return NdArrays.ofObjects(String.class, shape, init);
  }
}
