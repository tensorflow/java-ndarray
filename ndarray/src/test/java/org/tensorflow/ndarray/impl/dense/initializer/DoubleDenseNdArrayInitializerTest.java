...
import org.tensorflow.ndarray.initializer.DoubleNdArrayInitializerTestBase;

import java.util.function.Consumer;

public class DoubleDenseNdArrayInitializerTest extends DoubleNdArrayInitializerTestBase {

  @Override
  protected DoubleNdArray newArray(Shape shape, long numValues, Consumer<DoubleNdArrayInitializer> init) {
    return NdArrays.ofDoubles(shape, init);
  }
}
